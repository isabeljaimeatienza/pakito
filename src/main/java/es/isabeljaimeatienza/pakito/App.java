...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        //Setting font to the text 
        text4.setFont(Font.font(null, FontWeight.BOLD, 50));
        text4.setStyle("-fx-font-size: 40px;");
        text4.setStroke(Color.BLUE);
        text4.setFill(Color.WHITE);

        //setting the position of the text
        text4.setX(SCENE_WIDTH/2);
        text4.setY(SCENE_HEIGHT/2);
        ...
        timeline2 = new Timeline(
                ...
                new KeyFrame(Duration.seconds(0.017), new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent ActionEvent) {
                        ...
                        if (groupPersonajePosY <= 400) {
                            groupPersonajePosY += 5;
                            groupPersonajeCurrentSpeed = 0;

                        }else if (groupPersonajePosY >= 600) {
                            groupPersonajePosY -= 5;
                            groupPersonajeCurrentSpeed = 0;
                        ...
                        if (groupPersonajePosX >= 800) {
                            System.out.println("posicionxpersonaje:" + groupPersonajePosX);
                            groupPersonajePosX -= 5;

                            groupPersonajeCurrentSpeed = 0;

                        } else if (groupPersonajePosX < 20) {
                            groupPersonajePosX += 5;
                        ...
                        if (vida > 0) {
                            ...
                            } else if (score == 2 && level <= 5) {
                                ball2CurrentSpeedX = 8;
                                level++;
                                text3.setText("Level:" + String.valueOf(level));
                                score = 0;
                            }
